...
function renderBooks(filter) {
    ...
    const books = getBooks(); //stores our fake data books into 'books' NOTE: cost cannot change
  ...
  function priceHTML (originalPrice, salePrice) {
    ...
    if(!salePrice) { //this is saying if there is no sale price then to return 
